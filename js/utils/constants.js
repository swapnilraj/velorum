export const MESSAGE_SELECTOR = '._3oh- ._58nk';
export const MESSAGE_AREA_SELECTOR = '#js_1';
 ...
 */
export const LIST_BODY_CLASS = ['_1lix', '_1liy'];
export const LIST_LINE_BREAK_CLASS = ['_1li-'];
export const LIST_TITLE_CLASS = ['_1lj0'];

/**
 * Classes for list container
 */
